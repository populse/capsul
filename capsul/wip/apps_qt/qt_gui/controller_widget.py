...
class ControllerWidget(QtGui.QWidget):
    ...
    def __init__(self, controller, parent=None, name=None, live=False,
        ...
        # Parameter to store the connection status between the controller widget
        # and the controller
        self.connected = False
        # Parameter to store all the controller widget controls:
        # the keys correspond to the control name (a control name is 
        # associated to a controller trait with the same name), the dictionary
        # elements are 4-uplets of the form (trait, control_class,
    ...
    def update_controls(self):
        ...
        for control_name, control in self._controls.iteritems():
            ...
            # Message
            logging.debug("Check if we need to update '{0}': trait in '{1}' "
    ...
    def create_control(self, trait_name, trait):
        ...
        if control is None:
            ...
            # columns of the grid layout
                ...
                self._grid_layout.addWidget(control_instance, last_row, 1, 1, 1)
