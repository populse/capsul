...
# Capsul import
from capsul.apps_qt.qt_gui.controller_widget import (
...
print "Controller widget valid before edition: ", widget1.controller_widget.is_valid()

# Start the qt loop
app.exec_()

# Check if the controller widget is valid after edition
print "Controller widget valid after edition: ", widget1.controller_widget.is_valid()
