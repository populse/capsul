...
class ComplexPipeline(Pipeline):
    ...
    def pipeline_definition(self):
        ...
        self.add_switch(
            "select_threshold",
            ["threshold_1", "threshold_10", "threshold_100"],
        ...
        self.add_link(
            "pipeline_1.output_1->select_threshold.threshold_1_switch_output_a"
        )
        self.add_link(
            "pipeline_1.output_10->select_threshold.threshold_10_switch_output_a"
        )
        self.add_link(
            "pipeline_1.output_100->select_threshold.threshold_100_switch_output_a"
        )

        self.add_link(
            "pipeline_10.output_1->select_threshold.threshold_1_switch_output_b"
        )
        self.add_link(
            "pipeline_10.output_10->select_threshold.threshold_10_switch_output_b"
        )
        self.add_link(
            "pipeline_10.output_100->select_threshold.threshold_100_switch_output_b"
        )

        self.add_link(
            "pipeline_100.output_1->select_threshold.threshold_1_switch_output_c"
        )
        self.add_link(
            "pipeline_100.output_10->select_threshold.threshold_10_switch_output_c"
        )
        self.add_link(
            "pipeline_100.output_100->select_threshold.threshold_100_switch_output_c"
        )
