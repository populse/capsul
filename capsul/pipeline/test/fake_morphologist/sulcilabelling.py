...
class SulciLabelling(Pipeline):
    def pipeline_definition(self):
        ...
        self.add_process(
            "recognition2000",
            "capsul.pipeline.test.fake_morphologist.sulcilabellingann.SulciLabellingANN",
        )
        self.add_process(
            "SPAM_recognition09",
            "capsul.pipeline.test.fake_morphologist.sulcilabellingspam.SulciLabellingSPAM",
        )
        self.add_process(
            "CNN_recognition19",
            "capsul.pipeline.test.fake_morphologist.sulcideeplabeling.SulciDeepLabeling",
            skip_invalid=True,
        )
        self.add_switch(
            "select_Sulci_Recognition",
            ["recognition2000", "SPAM_recognition09", "CNN_recognition19"],
            ["output_graph"],
            opt_nodes=True,
            export_switch=False,
        )
        ...
        self.export_parameter(
            "CNN_recognition19", "graph", "data_graph", is_optional=False
        )
        ...
        self.export_parameter(
            "recognition2000", "model", "recognition2000_model", is_optional=True
        )
        self.export_parameter(
            "recognition2000",
            "model_hint",
        ...
        self.export_parameter(
            "recognition2000", "rate", "recognition2000_rate", is_optional=True
        )
        self.export_parameter(
            "recognition2000", "stopRate", "recognition2000_stopRate", is_optional=True
        )
        self.export_parameter(
            "recognition2000",
            "niterBelowStopProp",
        ...
        self.export_parameter(
            "CNN_recognition19", "roots", "CNN_recognition19_roots", is_optional=True
        )
        self.export_parameter(
            "CNN_recognition19",
            "model_file",
        ...
        self.export_parameter(
            "CNN_recognition19", "cuda", "CNN_recognition19_cuda", is_optional=True
        )
        self.add_link(
        ...
        self.export_parameter(
            "select_Sulci_Recognition", "output_graph", is_optional=False
        )
