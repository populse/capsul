...
class Morphologist(Pipeline):
    def pipeline_definition(self):
        ...
        self.export_parameter(
            "select_Talairach", "switch", "select_Talairach", is_optional=True
        )
        ...
        self.export_parameter(
            "PialMesh", "version", "pial_mesh_version", is_optional=False
        )
        self.add_link("pial_mesh_version->PialMesh_1.version")
        self.export_parameter(
            "SulciSkeleton", "version", "sulci_skeleton_version", is_optional=False
        )
        ...
        self.export_parameter(
            "CorticalFoldsGraph", "allow_multithreading", is_optional=False
        )
        self.add_link(
        ...
        self.add_link(
            "select_sulci_recognition->SulciRecognition_1.select_Sulci_Recognition"
        )
        self.export_parameter(
            "SulciRecognition_1",
        ...
        self.add_link(
            "sulci_recognition2000_forbid_unknown_label->SulciRecognition.recognition2000_forbid_unknown_label"
        )
        self.export_parameter(
            "SulciRecognition_1",
        ...
        self.add_link(
            "sulci_recognition2000_stop_rate->SulciRecognition.recognition2000_stopRate"
        )
        self.export_parameter(
            "SulciRecognition",
        ...
        self.add_link(
            "sulci_recognition2000_niter_below_stop_prop->SulciRecognition_1.recognition2000_niterBelowStopProp"
        )
        self.export_parameter(
            "SulciRecognition",
        ...
        self.add_link(
            "sulci_recognition_spam_local_or_markovian->SulciRecognition_1.SPAM_recognition09_local_or_markovian"
        )
        self.export_parameter(
            "SulciRecognition_1",
        ...
        self.add_link(
            "spm_normalization_version->Renorm.Normalization_NormalizeSPM_NormalizeSPM"
        )
        self.export_parameter(
            "importation",
            "output_database",
        ...
        self.add_link(
            "PrepareSubject.Normalization_normalized->normalized_t1mri", weak_link=True
        )
        self.export_parameter(
            "PrepareSubject",
        ...
        self.SplitBrain_split_template = (
            "/casa/host/build/share/brainvisa-share-5.1/hemitemplate/closedvoronoi.ima"
        )
