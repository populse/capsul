...
class Morphologist(Pipeline):
    ...
    def pipeline_definition(self):
        ...
        self.add_switch("select_Talairach", ['Normalization', 'StandardACPC'], ['Talairach_transform'], output_types=[traits.File(output=True, optional=False)], export_switch=False)
        ...
        self.export_parameter("PrepareSubject", "select_AC_PC_Or_Normalization", "select_Talairach", is_optional=False)
        ...
        self.export_parameter("PrepareSubject", "StandardACPC_Anterior_Commissure", "anterior_commissure", is_optional=False)
        self.export_parameter("PrepareSubject", "StandardACPC_Posterior_Commissure", "posterior_commissure", is_optional=False)
        self.export_parameter("PrepareSubject", "StandardACPC_Interhemispheric_Point", "interhemispheric_point", is_optional=False)
        self.export_parameter("PrepareSubject", "StandardACPC_Left_Hemisphere_Point", "left_hemisphere_point", is_optional=False)
        ...
        self.export_parameter("GreyWhiteClassification", "fix_random_seed", is_optional=False)
        ...
        self.export_parameter("CorticalFoldsGraph_1", "allow_multithreading", is_optional=False)
        ...
        self.export_parameter("SulciRecognition_1", "select_Sulci_Recognition", "select_sulci_recognition", is_optional=False)
        ...
        self.export_parameter("SulciRecognition", "SPAM_recognition09_global_recognition_model_type", "sulci_recognition_spam_global_model_type", is_optional=True)
