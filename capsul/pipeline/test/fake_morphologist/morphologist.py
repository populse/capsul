...
class Morphologist(Pipeline):
    ...
    def pipeline_definition(self):
        ...
        self.nodes["PrepareSubject"].nodes["select_AC_PC_Or_Normalization"].switch = 'Normalization'
        ...
        self.export_parameter("PialMesh", "fix_random_seed", is_optional=False)
        ...
        self.export_parameter("GlobalMorphometry", "subject", "GlobalMorphometry_subject", is_optional=True)
        ...
        self.export_parameter("Report", "subject", "Report_subject", is_optional=True)
        ...
        self.PrepareSubject_Normalization_NormalizeSPM_template = '/volatile/local/spm12-standalone/spm12_mcr/spm12/spm12/toolbox/OldNorm/T1.nii'
        ...
        self.PrepareSubject_Normalization_NormalizeBaladin_template = '/casa/host/build/share/brainvisa-share-5.2/anatomical_templates/MNI152_T1_1mm.nii.gz'
