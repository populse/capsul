...
class Morphologist(Pipeline):
    ...
    def pipeline_definition(self):
        ...
        self.add_switch("select_renormalization_commissures", ['skull_stripped', 'initial'], ['commissure_coordinates'], output_types=[traits.File(output=True, optional=False)], export_switch=False)
        self.add_switch("select_renormalization_transform", ['skull_stripped', 'initial'], ['Talairach_transform', 'MNI_transform'], output_types=[traits.File(output=True, optional=False), traits.File(output=True, optional=False)], export_switch=False)
        ...
        self.export_parameter("select_renormalization_commissures", "switch", "perform_skull_stripped_renormalization", is_optional=False)
        self.add_link("perform_skull_stripped_renormalization->select_renormalization_transform.switch")
        self.export_parameter("PialMesh_1", "fix_random_seed", is_optional=False)
