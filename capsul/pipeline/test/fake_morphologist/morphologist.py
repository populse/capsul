...
class Morphologist(Pipeline):
    ...
    def pipeline_definition(self):
        ...
        self.export_parameter("PrepareSubject", "Normalization_NormalizeFSL_allow_retry_initialization", "normalization_allow_retry_initialization", is_optional=False)
        ...
        self.export_parameter("SulciRecognition_1", "fix_random_seed", is_optional=False)
