...
class Morphologist(Pipeline):
    ...
    def pipeline_definition(self):
        ...
        self.export_parameter("PrepareSubject", "Normalization_NormalizeSPM_allow_retry_initialization", "normalization_allow_retry_initialization", is_optional=False)
        ...
        self.export_parameter("GreyWhiteClassification_1", "fix_random_seed", is_optional=False)
