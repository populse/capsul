...
class Morphologist(Pipeline):
    ...
    def pipeline_definition(self):
        ...
        self.add_switch("select_renormalization_commissures", ['skull_stripped', 'initial'], ['commissure_coordinates'], switch_value='initial', export_switch=False)
        self.add_switch("select_renormalization_transform", ['skull_stripped', 'initial'], ['Talairach_transform', 'MNI_transform'], switch_value='initial', export_switch=False)
        ...
        self.export_parameter("CorticalFoldsGraph_1", "graph_version", "CorticalFoldsGraph_graph_version")
        ...
        self.export_parameter("Renorm", "TalairachFromNormalization_transform_chain_ACPC_to_Normalized", "PrepareSubject_TalairachFromNormalization_transform_chain_ACPC_to_Normalized")
        ...
        self.export_parameter("Renorm", "Normalization_NormalizeSPM_allow_retry_initialization", "normalization_allow_retry_initialization")
        ...
        self.export_parameter("select_renormalization_transform", "switch", "perform_skull_stripped_renormalization")
        self.add_link("perform_skull_stripped_renormalization->select_renormalization_commissures.switch")
        self.export_parameter("SulciRecognition", "fix_random_seed")
        ...
        self.export_parameter("SulciSkeleton_1", "version", "sulci_skeleton_version")
        self.add_link("sulci_skeleton_version->SulciSkeleton.version")
        self.export_parameter("CorticalFoldsGraph_1", "compute_fold_meshes")
        ...
        self.export_parameter("SulciRecognition_1", "recognition2000_forbid_unknown_label", "sulci_recognition2000_forbid_unknown_label")
        self.add_link("sulci_recognition2000_forbid_unknown_label->SulciRecognition.recognition2000_forbid_unknown_label")
        self.export_parameter("SulciRecognition", "recognition2000_model_hint", "sulci_recognition2000_model_hint")
        ...
        self.export_parameter("SulciRecognition_1", "SPAM_recognition09_local_or_markovian", "sulci_recognition_spam_local_or_markovian")
        ...
        self.export_parameter("SulciRecognition_1", "CNN_recognition19_rebuild_attributes", "rebuild_graph_attributes_after_split")
        ...
        self.export_parameter("PrepareSubject", "commissure_coordinates", "Renorm_commissure_coordinates")
        ...
        self.export_parameter("PrepareSubject", "Normalization_normalized", "normalized_t1mri", weak_link=True)
