...
class BaladinNormalizationPipeline(Pipeline):
    def pipeline_definition(self):
        ...
        self.export_parameter(
            "NormalizeBaladin", "anatomy_data", "t1mri", is_optional=False
        )
        ...
        self.template = "/casa/host/build/share/brainvisa-share-5.1/anatomical_templates/MNI152_T1_1mm.nii.gz"
