...
class SPMNormalization(Pipeline):
    ...
    def pipeline_definition(self):
        ...
        self.export_parameter("normalization_t1_spm12_reinit", "allow_retry_initialization")
        ...
        self.export_parameter("normalization_t1_spm8_reinit", "cutoff_option")
        self.add_link("cutoff_option->normalization_t1_spm12_reinit.cutoff_option")
        self.export_parameter("normalization_t1_spm8_reinit", "nbiteration")
