...
class SPMNormalization(Pipeline):
    ...
    def pipeline_definition(self):
        ...
        # links
        self.export_parameter("NormalizeSPM", "switch", "NormalizeSPM")
        self.export_parameter("converter", "read", "t1mri")
        self.add_link("t1mri->ReorientAnatomy.t1mri")
        self.add_link("t1mri->ConvertSPMnormalizationToAIMS.source_volume")
        self.export_parameter("normalization_t1_spm8_reinit", "anatomical_template", "template")
        ...
        self.export_parameter("normalization_t1_spm8_reinit", "allow_retry_initialization")
        self.add_link("allow_retry_initialization->normalization_t1_spm12_reinit.allow_retry_initialization")
        self.export_parameter("normalization_t1_spm8_reinit", "init_translation_origin")
        self.add_link("init_translation_origin->normalization_t1_spm12_reinit.init_translation_origin")
        self.export_parameter("normalization_t1_spm8_reinit", "voxel_size")
        self.add_link("voxel_size->normalization_t1_spm12_reinit.voxel_size")
        self.export_parameter("normalization_t1_spm12_reinit", "cutoff_option")
        self.add_link("cutoff_option->normalization_t1_spm8_reinit.cutoff_option")
        self.export_parameter("normalization_t1_spm12_reinit", "nbiteration")
        self.add_link("nbiteration->normalization_t1_spm8_reinit.nbiteration")
        self.export_parameter("ConvertSPMnormalizationToAIMS", "target", "ConvertSPMnormalizationToAIMS_target")
        self.export_parameter("ConvertSPMnormalizationToAIMS", "normalized_volume", "ConvertSPMnormalizationToAIMS_normalized_volume")
        self.export_parameter("ConvertSPMnormalizationToAIMS", "removeSource", "ConvertSPMnormalizationToAIMS_removeSource")
        ...
        self.export_parameter("NormalizeSPM", "spm_transformation")
        self.add_link("NormalizeSPM.spm_transformation->ConvertSPMnormalizationToAIMS.read")
        self.export_parameter("NormalizeSPM", "normalized_t1mri")
