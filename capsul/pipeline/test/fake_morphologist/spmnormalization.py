...
class SPMNormalization(Pipeline):
    ...
    def pipeline_definition(self):
        ...
        self.export_parameter("normalization_t1_spm12_reinit", "voxel_size", is_optional=False)
        ...
        self.reorder_fields(("NormalizeSPM",
            "t1mri",
            "transformation",
            "spm_transformation",
            "normalized_t1mri",
        ...
        self.template = '/volatile/local/spm12-standalone/spm12_mcr/spm12/spm12/toolbox/OldNorm/T1.nii'
