...
class SulciLabellingSPAM(Pipeline):
    ...
    def pipeline_definition(self):
        ...
        self.export_parameter("global_recognition", "labels_translation_map", "global_recognition_labels_translation_map", is_optional=False)
        ...
        self.export_parameter("local_recognition", "initial_transformation", "global_recognition_initial_transformation", is_optional=True)
