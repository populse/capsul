...
class SulciLabellingSPAM(Pipeline):
    def pipeline_definition(self):
        ...
        self.add_process(
            "global_recognition",
            "capsul.pipeline.test.fake_morphologist.sulcilabellingspamglobal.SulciLabellingSPAMGlobal",
        )
        self.add_process(
            "local_recognition",
            "capsul.pipeline.test.fake_morphologist.sulcilabellingspamlocal.SulciLabellingSPAMLocal",
        )
        self.add_process(
            "markovian_recognition",
            "capsul.pipeline.test.fake_morphologist.sulcilabellingspammarkov.SulciLabellingSPAMMarkov",
        )
        self.add_switch(
            "local_or_markovian",
            ["local_recognition", "markovian_recognition"],
            ["output_graph"],
            export_switch=False,
        )
        ...
        self.export_parameter(
            "local_or_markovian", "switch", "local_or_markovian", is_optional=True
        )
        self.export_parameter("global_recognition", "data_graph", is_optional=False)
        self.export_parameter(
            "markovian_recognition", "fix_random_seed", is_optional=False
        )
        self.export_parameter(
            "markovian_recognition",
        ...
        self.add_link(
            "global_recognition_labels_translation_map->global_recognition.labels_translation_map"
        )
        self.export_parameter(
            "global_recognition",
            "labels_priors",
        ...
        self.add_link(
            "global_recognition_initial_transformation->global_recognition.initial_transformation"
        )
        self.export_parameter(
            "global_recognition",
            "model_type",
        ...
        self.export_parameter(
            "global_recognition", "model", "global_recognition_model", is_optional=True
        )
        self.export_parameter(
            "local_recognition", "model", "local_recognition_model", is_optional=True
        )
        self.export_parameter(
            "local_recognition",
            "local_referentials",
