...
class SulciLabellingSPAM(Pipeline):
    ...
    def pipeline_definition(self):
        ...
        self.add_switch("local_or_markovian", ['markovian_recognition', 'local_recognition'], ['output_graph'], output_types=[traits.File(output=True, optional=False)], switch_value='local_recognition', export_switch=False)
