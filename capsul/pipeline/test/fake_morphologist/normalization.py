...
class Normalization(Pipeline):
    ...
    def pipeline_definition(self):
        ...
        self.add_switch("select_Normalization_pipeline", ['NormalizeSPM', 'NormalizeBaladin', 'NormalizeFSL', 'Normalization_AimsMIRegister'], ['transformation', 'normalized', 'reoriented_t1mri'], switch_value='NormalizeFSL', export_switch=False)

        # links
        self.export_parameter("select_Normalization_pipeline", "switch", "select_Normalization_pipeline")
        self.export_parameter("select_Normalization_pipeline", "Normalization_AimsMIRegister_switch_reoriented_t1mri", "t1mri")
        ...
        self.export_parameter("NormalizeSPM", "allow_flip_initial_MRI")
        ...
        self.export_parameter("NormalizeBaladin", "ReorientAnatomy_commissures_coordinates", "commissures_coordinates")
