...
class SulciDeepLabeling(Process):
    def __init__(self, **kwargs):
        ...
        self.add_field("rebuild_attributes", bool)
        ...
        self.add_field("cuda", int, doc='device on which to run the training(-1 for cpu, i>=0 for the i-th gpu)')
        self.cuda = -1
        self.add_field("fix_random_seed", bool, doc='Use same random sequence')
