...
class morpho_report(Process):
    def __init__(self, **kwargs):
        ...
        self.add_field("left_grey_white", File, read=True, allowed_extensions=['.nii.gz', '.svs', '.bmp', '.dcm', '', '.i', '.v', '.fdf', '.mgh', '.mgz', '.gif', '.ima', '.dim', '.ndpi', '.vms', '.vmu', '.jpg', '.scn', '.mnc', '.nii', '.pbm', '.pgm', '.png', '.ppm', '.img', '.hdr', '.svslide', '.tiff', '.tif', '.vimg', '.vinfo', '.vhdr', '.bif', '.xbm', '.xpm', '.czi', '.mnc.gz'], optional=True, write=False)
        self.add_field("right_grey_white", File, read=True, allowed_extensions=['.nii.gz', '.svs', '.bmp', '.dcm', '', '.i', '.v', '.fdf', '.mgh', '.mgz', '.gif', '.ima', '.dim', '.ndpi', '.vms', '.vmu', '.jpg', '.scn', '.mnc', '.nii', '.pbm', '.pgm', '.png', '.ppm', '.img', '.hdr', '.svslide', '.tiff', '.tif', '.vimg', '.vinfo', '.vhdr', '.bif', '.xbm', '.xpm', '.czi', '.mnc.gz'], optional=True, write=False)
        ...
        self.add_field("talairach_transform", File, read=True, allowed_extensions=['.trm'], optional=True, write=False)
        self.add_field("brain_volumes_file", File, read=True, allowed_extensions=['.csv'], optional=True, write=False)
        self.add_field("normative_brain_stats", File, read=True, allowed_extensions=['.json'], optional=True, write=False)
        self.add_field("report", File, write=True, allowed_extensions=['.pdf'], read=True)
