...
class BrainOrientation(Pipeline):
    ...
    def pipeline_definition(self):
        ...
        self.export_parameter("StandardACPC", "Anterior_Commissure", "StandardACPC_Anterior_Commissure", is_optional=False)
        self.export_parameter("StandardACPC", "Posterior_Commissure", "StandardACPC_Posterior_Commissure", is_optional=False)
        self.export_parameter("StandardACPC", "Interhemispheric_Point", "StandardACPC_Interhemispheric_Point", is_optional=False)
        self.export_parameter("StandardACPC", "Left_Hemisphere_Point", "StandardACPC_Left_Hemisphere_Point", is_optional=False)
