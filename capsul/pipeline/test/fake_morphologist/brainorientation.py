...
class BrainOrientation(Pipeline):
    ...
    def pipeline_definition(self):
        ...
        self.add_switch("select_AC_PC_Or_Normalization", ['Normalization', 'StandardACPC'], ['commissure_coordinates', 'reoriented_t1mri', 'talairach_transformation'], make_optional=['talairach_transformation'], switch_value='StandardACPC', export_switch=False)

        # links
        self.export_parameter("select_AC_PC_Or_Normalization", "switch", "select_AC_PC_Or_Normalization")
        self.export_parameter("Normalization", "t1mri", "T1mri")
        self.add_link("T1mri->StandardACPC.T1mri")
        self.export_parameter("StandardACPC", "allow_flip_initial_MRI")
        self.add_link("allow_flip_initial_MRI->Normalization.allow_flip_initial_MRI")
        self.export_parameter("StandardACPC", "Normalised", "StandardACPC_Normalised")
        self.export_parameter("StandardACPC", "Anterior_Commissure", "StandardACPC_Anterior_Commissure")
        self.export_parameter("StandardACPC", "Posterior_Commissure", "StandardACPC_Posterior_Commissure")
        self.export_parameter("StandardACPC", "Interhemispheric_Point", "StandardACPC_Interhemispheric_Point")
        self.export_parameter("StandardACPC", "Left_Hemisphere_Point", "StandardACPC_Left_Hemisphere_Point")
        self.export_parameter("StandardACPC", "remove_older_MNI_normalization", "StandardACPC_remove_older_MNI_normalization")
        self.export_parameter("StandardACPC", "older_MNI_normalization", "StandardACPC_older_MNI_normalization")
        ...
        self.export_parameter("Normalization", "NormalizeFSL_template", "Normalization_NormalizeFSL_template")
        ...
        self.export_parameter("Normalization", "NormalizeSPM_template", "Normalization_NormalizeSPM_template")
        ...
        self.export_parameter("Normalization", "NormalizeBaladin_template", "Normalization_NormalizeBaladin_template")
        ...
        self.export_parameter("Normalization", "Normalization_AimsMIRegister_anatomical_template", "Normalization_Normalization_AimsMIRegister_anatomical_template")
        ...
        self.export_parameter("Normalization", "transformation", "normalization_transformation", weak_link=True)
        ...
        self.export_parameter("Normalization", "normalized", "Normalization_normalized", weak_link=True)
        self.export_parameter("Normalization", "NormalizeFSL_NormalizeFSL_transformation_matrix", "Normalization_NormalizeFSL_NormalizeFSL_transformation_matrix", weak_link=True)
        self.export_parameter("Normalization", "NormalizeSPM_spm_transformation", "Normalization_NormalizeSPM_spm_transformation", weak_link=True)
        self.export_parameter("Normalization", "NormalizeBaladin_NormalizeBaladin_transformation_matrix", "Normalization_NormalizeBaladin_NormalizeBaladin_transformation_matrix", weak_link=True)
        self.export_parameter("Normalization", "Normalization_AimsMIRegister_transformation_to_template", "Normalization_Normalization_AimsMIRegister_transformation_to_template", weak_link=True)
        self.export_parameter("Normalization", "Normalization_AimsMIRegister_transformation_to_ACPC", "Normalization_Normalization_AimsMIRegister_transformation_to_ACPC", weak_link=True)
        ...
        self.export_parameter("select_AC_PC_Or_Normalization", "commissure_coordinates")
        self.export_parameter("select_AC_PC_Or_Normalization", "reoriented_t1mri")
        self.export_parameter("select_AC_PC_Or_Normalization", "talairach_transformation")
