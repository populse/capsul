...
class SulciLabellingSPAMLocal(Process):
    def __init__(self, **kwargs):
        ...
        self.add_field("direction_priors", File, read=True, allowed_extensions=['.dat'], write=False)
        self.add_field("angle_priors", File, read=True, allowed_extensions=['.dat'], write=False)
        self.add_field("translation_priors", File, read=True, allowed_extensions=['.dat'], write=False)
        self.add_field("output_local_transformations", Directory, write=True, allowed_extensions=[''], optional=True, read=True)
        self.add_field("initial_transformation", File, read=True, allowed_extensions=['.trm'], optional=True, write=False)
        self.add_field("global_transformation", File, read=True, allowed_extensions=['.trm'], optional=True, write=False)
