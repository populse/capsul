...
class SulciLabellingSPAMLocal(Process):
    def __init__(self, **kwargs):
        ...
        self.add_field("local_referentials", File, read=True, extensions=['.dat'], write=False)
        self.add_field("direction_priors", File, read=True, extensions=['.dat'], write=False)
        self.add_field("angle_priors", File, read=True, extensions=['.dat'], write=False)
        self.add_field("translation_priors", File, read=True, extensions=['.dat'], write=False)
