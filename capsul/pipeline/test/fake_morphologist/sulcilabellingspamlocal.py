...
class SulciLabellingSPAMLocal(Process):
    def __init__(self, **kwargs):
        ...
        self.add_field("local_referentials", File, read=True, extensions=['.dat'], dataset='shared', write=False)
        self.add_field("direction_priors", File, read=True, extensions=['.dat'], dataset='shared', write=False)
        self.add_field("angle_priors", File, read=True, extensions=['.dat'], dataset='shared', write=False)
        self.add_field("translation_priors", File, read=True, extensions=['.dat'], dataset='shared', write=False)
        self.add_field("output_local_transformations", Directory, write=True, extensions=[''], optional=True, read=True)
        self.add_field("initial_transformation", File, read=True, extensions=['.trm'], optional=True, dataset=None, write=False)
        self.add_field("global_transformation", File, read=True, extensions=['.trm'], optional=True, write=False)
