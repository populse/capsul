...
class TestProcessUserTrait(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.p1 = executable("capsul.process.test.test_fields.DummyProcess")
        self.p2 = executable("capsul.process.test.test_fields.DummyProcess")
    ...
    def test_class_user_parameters(self):
        ...
        for field in self.p1.fields():
            ...
            # between instances
            self.assertEqual(
                field._dataclass_field is self.p2.field(field.name)._dataclass_field,
                field.class_field,
            )
