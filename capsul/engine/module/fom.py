...
def edition_widget(engine, environment, config_id="fom"):
    ...
    controller.add_trait(
        "input_fom", traits.Str(traits.Undefined, output=False, desc="input FOM")
    )
    controller.add_trait(
        "output_fom", traits.Str(traits.Undefined, output=False, desc="output FOM")
    )
    controller.add_trait(
        "shared_fom", traits.Str(traits.Undefined, output=False, desc="shared data FOM")
    )
    controller.add_trait(
        "volumes_format",
    ...
    controller.add_trait(
        "meshes_format",
        traits.Str(traits.Undefined, output=False, desc="Format used for meshes"),
    )
    controller.add_trait(
        "auto_fom",
        traits.Bool(
    ...
    controller.add_trait(
        "input_directory",
        traits.Directory(
            traits.Undefined, output=False, desc="input study data directory"
        ),
    )
    controller.add_trait(
        "output_directory",
        traits.Directory(
            traits.Undefined, output=False, desc="output study data directory"
        ),
    )
    ...
    if conf:
        ...
        controller.volumes_format = fconf.get("volumes_format", traits.Undefined)
        ...
        controller.input_directory = fconf.get("input_directory", traits.Undefined)
        controller.output_directory = fconf.get("output_directory", traits.Undefined)
