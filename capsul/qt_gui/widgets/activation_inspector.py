...
class ActivationInspectorApp(Application):
    ...
    def init_window(self):
        ...
        self.pipeline_window = PipelineDeveloperView(
            self.pipeline, show_sub_pipelines=True
        )
...
class ActivationInspector(QtGui.QWidget):
    ...
    def __init__(
        self, pipeline, ui_file=None, record_file=None, developer_view=None, parent=None
    ):
        ...
        self.ui.events.currentRowChanged.connect(self.update_pipeline_activation)
        self.ui.btnUpdate.clicked.connect(self.refresh_activation_from_record)
